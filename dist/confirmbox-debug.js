define("aliscript/dialog/1.0.1/confirmbox-debug", [ "$-debug", "./dialog-debug", "arale/overlay/1.1.4/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/overlay/1.1.4/mask-debug", "arale/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "./dialog-debug.handlebars", "./confirmbox-debug.handlebars", "./dialog-debug.css" ], function(require, exports, module) {
    ...
    var ConfirmBox = Dialog.extend({
        attrs: {
            title: "默认标题",
            confirmTpl: '<a class="ali-button ali-button-morange" href="javascript:;">确定</a>',
            cancelTpl: '<a class="ali-button ali-button-mwhite" href="javascript:;">取消</a>',
            message: "默认内容"
        },
        setup: function() {
...
define("aliscript/dialog/1.0.1/dialog-debug", [ "$-debug", "arale/overlay/1.1.4/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/overlay/1.1.4/mask-debug", "arale/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug" ], function(require, exports, module) {
    ...
    var Dialog = Overlay.extend({
        ...
        attrs: {
            // 模板
            template: require("aliscript/dialog/1.0.1/dialog-debug.handlebars"),
            // 对话框触发点
            trigger: {
                value: null,
                getter: function(val) {
...
define("aliscript/dialog/1.0.1/dialog-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
...
define("aliscript/dialog/1.0.1/confirmbox-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
        ...
        function program1(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + '-header" data-role="title">';
...
define("aliscript/dialog/1.0.1/dialog-debug.css", [], function() {
    seajs.importStyle(".aliscript-dialog-1_0_1 .ui-dialog{background-color:rgba(0,0,0,.5);border:0;FILTER:progid:DXImageTransform.Microsoft.Gradient(startColorstr=#88000000, endColorstr=#88000000);padding:6px;outline:0}.aliscript-dialog-1_0_1 .ui-dialog-content{background:#fff}:root .aliscript-dialog-1_0_1 .ui-dialog{FILTER:none\\9}.aliscript-dialog-1_0_1 .ui-dialog-close{color:#999;cursor:pointer;display:block;font-family:tahoma;font-size:24px;font-weight:700;height:18px;line-height:14px;position:absolute;right:16px;text-decoration:none;top:16px;z-index:10}.aliscript-dialog-1_0_1 .ui-dialog-close:hover{color:#666;text-shadow:0 0 2px #aaa}.aliscript-dialog-1_0_1 .ui-dialog-title{height:45px;font-size:16px;font-family:'微软雅黑','黑体',Arial;line-height:46px;border-bottom:1px solid #E1E1E1;color:#4d4d4d;text-indent:20px;background-color:#f9f9f9;background:-webkit-gradient(linear,left top,left bottom,from(#fcfcfc),to(#f9f9f9));background:-moz-linear-gradient(top,#fcfcfc,#f9f9f9);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#fcfcfc', endColorstr='#f9f9f9');background:-o-linear-gradient(top,#fcfcfc,#f9f9f9);background:-ms-linear-gradient(top,#fcfcfc,#f9f9f9);background:linear-gradient(top,#fcfcfc,#f9f9f9)}.aliscript-dialog-1_0_1 .ui-dialog-container{padding:15px 20px 20px;font-size:12px}.aliscript-dialog-1_0_1 .ui-dialog-message{margin-bottom:15px}.aliscript-dialog-1_0_1 .ui-dialog-operation{zoom:1}.aliscript-dialog-1_0_1 .ui-dialog-confirm,.aliscript-dialog-1_0_1 .ui-dialog-cancel{display:inline}.aliscript-dialog-1_0_1 .ui-dialog-operation .ui-dialog-confirm{margin-right:4px}.aliscript-dialog-1_0_1 .ui-dialog-button-orange,.aliscript-dialog-1_0_1 .ui-dialog-button-white{display:inline-block;*display:inline;*zoom:1;text-align:center;text-decoration:none;vertical-align:middle;cursor:pointer;font-size:12px;font-weight:700;border-radius:2px;padding:0 12px;line-height:23px;height:23px;*overflow:visible;background-image:none}.aliscript-dialog-1_0_1 a.ui-dialog-button-orange:hover,.aliscript-dialog-1_0_1 a.ui-dialog-button-white:hover{text-decoration:none}.aliscript-dialog-1_0_1 .ui-dialog-button-orange{color:#fff;border:1px solid #d66500;background-color:#f57403}.aliscript-dialog-1_0_1 .ui-dialog-button-orange:hover{background-color:#fb8318}.aliscript-dialog-1_0_1 .ui-dialog-button-white{border:1px solid #afafaf;background-color:#f3f3f3;color:#777}.aliscript-dialog-1_0_1 .ui-dialog-button-white:hover{border:1px solid #8e8e8e;background-color:#fcfbfb;color:#676d70}");
});
